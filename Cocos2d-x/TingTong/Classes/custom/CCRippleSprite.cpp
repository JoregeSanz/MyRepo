...
void pgeRippleSprite::addWave(){
    this->addRipple(m_ptCenter, RIPPLE_TYPE_WATER, 6.0f);

}
void pgeRippleSprite::setCenter(CCPoint pt)
{
    m_ptCenter = pt;
    //    addWave();
    schedule(schedule_selector(pgeRippleSprite::addWave), 1);
...
//   this->addRipple(pos, RIPPLE_TYPE_WATER, 6.0f);
